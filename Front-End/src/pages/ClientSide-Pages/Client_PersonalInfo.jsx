...
import ClientInfo from '../../components/ClientSide/ClientInfo';
        ...
        <div>
            <div style={{ marginTop: '80px' }}>
                ...
                <div className="container mt-5">
                    <h2> Personal Info </h2>
                    <p className="text-muted mb-2">Here you can view and edit your personal information.</p>
...
export default Client_PersonalInfo;
